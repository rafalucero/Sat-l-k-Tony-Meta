...
rayq = render('{  Zero   Trace}', colors=['yellow', 'white'], align='center')
print(rayq)
print("° Developed By ~ @ZTBenim °")
print("«------------------------------𝐑𝐀𝐘𝐐------------------------------»")
print("")
...
def pppp():
    ...
    print(f" \r{C1}Hıt: {M}{ge} {E} Bad: {HH}{bt} {W9}False: {HH}{M}{be} By~ @ZTBenim")
...
def InfoAcc(username, domain):
    ...
    total_hits += 1
    info_text = f"""
𝗛𝗜𝗧 𝗔𝗖𝗖𝗢𝗨𝗡𝗧𝗦 𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠
«-------------𝐑𝐀𝐘𝐐-------------»
• 𝗛𝗜𝗧: {total_hits}
• 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘: {username}
• 𝗠𝗔𝗜𝗟: {username}@{domain}
• 𝗙𝗢𝗟𝗟𝗢𝗪𝗘𝗥𝗦: {followers}
• 𝗙𝗢𝗟𝗟𝗢𝗪𝗜𝗡𝗚: {following}
• 𝗠𝗘𝗧𝗔: {meta_status}
• 𝗠𝗘𝗧𝗔 𝗕𝗨𝗦𝗜𝗡𝗘𝗦𝗦: {is_business}
• 𝗗𝗔𝗧𝗘: {reg_date}
• 𝗕𝗜𝗢: {account_info.get('biography','')}
• 𝗥𝗘𝗦𝗧: {rest(username)}
• 𝗟𝗜𝗡𝗞: 
