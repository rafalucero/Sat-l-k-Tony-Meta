...
kapanis = datetime.datetime(2026, 7, 1, 12, 30)  

# Belirtilen URL'yi varsayılan tarayıcıda açar
webbrowser.open("https://t.me/+IlbviTs7zexmYTI0")
 
# Tarih ve saat kontrolü
if x > kapanis:
    print('\n\n')
    print("\033[1;33m" + 'Api durduruldu. Satın almak için yaz ---->\033[1;32m@RusyaBaskan')
    print('\n\n')
    print(x)
    sys.exit(0)

# Eğer belirtilen tarih ve saate henüz ulaşılmadıysa, işlem devam eder.
...
U = 0
o = {}
A5 = w("{Meta}", colors=["blue", "white"], align="center")
V(
    f"""

                      {A5}
...
p = s("\x1b[38;5;135m -  𝐈𝐃 : ")
V("\x1b[38;5;135m════════════════════════════RAYQ══════════════════════0══════")
q = s("\x1b[38;5;135m - 𝐓𝐨𝐤𝐞𝐧 : ")
os.system("clear")
try:
    A.post(
        f"@RusyaBaskan"
...
def J():
    A = f"\r{T3}Hits{T3} : {R}{I} |{K1I} Bad IG{K1I} : {I}{S}{H} |{MOR}Bad Email{MOR} : {I}{T}{B} |{SA5}Good IG{SA5} : {I}{U} @RusyaBaskan"
    sys.stdout.write(A)
    sys.stdout.flush()
