...
print(f"{Fore.CYAN}Developed by @FKurucu")
print("")
...
def pppp():
    ...
    print(f" \r{C1}Hıt: {M}{ge} {E} Bad: {HH}{bt} {W9}False: {HH}{M}{be} By~ @FKurucu")
